...
vx_status fcw_main_pre_init(FcwMainPreContext *context, const FcwMainPreConfig *config,
                            FcwAlarmOutputFunc output, void *user);
...
vx_status fcw_main_pre_add_tidl_channel(FcwMainPreContext *context, const sTIDL_IOBufDesc_t *io,
                                        vx_object_array output, vx_uint32 channel);
 ...
 */
vx_status fcw_main_pre_process_tidl_frame(FcwMainPreContext *context, const sTIDL_IOBufDesc_t *io,
                                          vx_object_array output, vx_uint32 num_channels,
